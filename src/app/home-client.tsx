...
export default function HomeV2Page({
  ...
  // Server-fetched so the property grid is in the initial HTML (SEO); no
  // client refetch needed.
  const properties = initialProperties;
  const propertyPhotos = initialPhotos;
  ...
  // Load any in-progress booking-search session (sessionStorage)
  useEffect(() => {
