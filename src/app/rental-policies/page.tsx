  ...
  return (
    <div className="min-h-screen flex flex-col font-(family-name:--font-plus-jakarta) bg-background">
        ...
        <div className="absolute inset-0 flex flex-col justify-end pb-16 sm:pb-24 px-4 sm:px-6">
          <div className="max-w-7xl mx-auto w-full">
            ...
            <h1 className="text-5xl sm:text-7xl font-bold tracking-tight text-white leading-[0.95] max-w-4xl">
              The full terms of staying with us.
            </h1>
            <p className="text-lg sm:text-xl text-white/80 mt-6 max-w-2xl leading-relaxed">
              Please read these policies carefully before booking. Your
              reservation, and every person you bring with you, is bound by
              them.
            </p>
      ...
      <section className="border-y bg-amber-50 dark:bg-amber-950/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
          <div className="flex items-start gap-4">
            <div className="inline-flex items-center justify-center h-10 w-10 rounded-full bg-amber-500/15 text-amber-700 dark:text-amber-400 shrink-0">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                By booking or occupying any Summit Lakeside property, you
                confirm that you have read, understood, and agreed to every
                provision below. If any section is unclear, contact us before
                you book.
              </p>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14">
          {/* TOC */}
          <aside className="lg:col-span-3">
            <div className="lg:sticky lg:top-24">
              <div className="text-xs uppercase tracking-[0.3em] text-muted-foreground font-semibold mb-5">
                Contents
              </div>
              <nav className="space-y-1 max-h-[70vh] overflow-auto pr-2">
                {SECTIONS.map((s) => (
                  <a
                    key={s.id}
                    href={`#${s.id}`}
                    className="group flex items-baseline gap-3 py-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors"
                  >
          ...
          {/* Content */}
          <div className="lg:col-span-9 space-y-14 sm:space-y-20">
                  ...
                  {section.items && section.items.length > 0 && (
                    <ul className="space-y-3 pt-2">
                      {section.items.map((item, i) => (
                        <li
                          key={i}
                          className="flex gap-3 pl-0 sm:pl-2 border-l-2 border-muted py-0.5"
                        >
            ...
            {/* Signature-style acknowledgement block */}
            <div className="rounded-3xl border bg-muted/30 p-6 sm:p-10">
              <h3 className="text-xl font-bold mb-3">
                Acknowledgement on booking
              </h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                When you complete the registration step for your reservation,
                you will be asked to sign electronically to confirm that you
                have read and agreed to this Agreement in its entirety. Your
                electronic signature has the same legal force as a handwritten
                one under the federal E-SIGN Act and the Pennsylvania Uniform
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mt-4 leading-relaxed">
                ...
                clarify what applies to a specific property, or work with you
                on reasonable accommodations. A real person will reply.
              </p>
            </div>
